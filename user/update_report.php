<?php
include '../admin/user_create_register.php';
// session_start();
...
?>
 ...
 <div class="flex justify-center mt-10 sm:mt-0">
  <div class=" mb-20 mt-20 flex flex-col">
    ...
    <form action="update_report_form.php" method="post" enctype="multipart/form-data" class="p-5 bg-indigo-300">
      <h1 class="text-xl font-bold m-2 mb-2 relative bottom-3 ">
        ...
        <input type="submit" name="upload_excel" class="bg-yellow-300 p-2 rounded hover:shadow-xl ml-80">
    </form>
      <form action="update_report_form.php" method="POST">
...
document.getElementById("cont").remove();
          ...
          <div class="px-4 py-3 bg-gray-50 text-center sm:px-6"><input type="hidden" value="<?php echo $id; ?>" name="id" id="id" autocomplete="given-name" class="h-6 mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
...
var count1 = 0;
  ...
  var body = document.getElementById("inside1");

  // creates a <table> element and a <tbody> element
  var tbl = document.createElement("table");
  tbl.setAttribute('class','temptable');
  ...
  for (var i = 0; i < 1; i++) {
    ...
    for (var j = 0; j < 1; j++) {
      ...
      // the end of the table row
        ...
        label.setAttribute("class", "block text-sm font-medium text-gray-700");
        var t = document.createTextNode("Patient Type");
        label.setAttribute("for", "Patient Type");
        label.appendChild(t);
        document.getElementById("inside1").insertBefore(label,document.getElementById("male"));
        var newField = document.createElement('input');
        newField.setAttribute('type','text');
        newField.setAttribute('id','male');
        newField.setAttribute('name','add_type');
        newField.setAttribute('class','ml-4 mr-6 h-10 mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm');
        newField.setAttribute('siz',50);
        newField.setAttribute('placeholder','Patient Type');
        ...
        var cell = document.createElement("td");
        var label = document.createElement("LABEL");
        var t = document.createTextNode("No. of patients");
        label.setAttribute("for", "Patient Type");
        label.setAttribute("class", "block text-sm font-medium text-gray-700");
        label.appendChild(t);
        document.getElementById("inside1").insertBefore(label,document.getElementById("male1"))
        var newField = document.createElement('input');
        newField.setAttribute('type','text');
        newField.setAttribute('id','male1');
        newField.setAttribute('name','no_of_patients[]');
        newField.setAttribute('class','ml-4 mr-6 h-10 mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm');
        newField.setAttribute('siz',50);
...
function remove_table1() {

var body = document.getElementById("inside1");
  
if( count1 >=1 ){
  document.getElementsByClassName('temptable')[0].remove();
  count1--;
}
}
</script>
...
var count2 = 0;
  function generate_table2() {
    count2++;
  // get the reference for the body
  var body = document.getElementById("inside2");
  ...
  for (var i = 0; i < 1; i++) {
    ...
    for (var j = 0; j < 1; j++) {
      ...
      // the end of the table row
        ...
        var newField = document.createElement('input');
        newField.setAttribute('type','text');
        newField.setAttribute('name','surgery_name1[]');
        newField.setAttribute('class','ml-4 h-10 mr-4 mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm');
        newField.setAttribute('siz',50);
        newField.setAttribute('placeholder','Another Field');
        cell.appendChild(newField);
        row.appendChild(cell);
        ...
        var newField = document.createElement('input');
        newField.setAttribute('type','text');
        newField.setAttribute('name','no_of_surgeries1[]');
        newField.setAttribute('class','ml-6 h-10 mr-4 mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm');
        newField.setAttribute('siz',50);
        newField.setAttribute('placeholder','Another Field');
        cell.appendChild(newField);
        row.appendChild(cell);
...
var count3 = 0;
  function generate_table3() {
    count3++;
  // get the reference for the body
  var body = document.getElementById("inside3");
  ...
  for (var i = 0; i < 1; i++) {
    ...
    for (var j = 0; j < 1; j++) {
      ...
      // the end of the table row
        ...
        var newField = document.createElement('input');
        newField.setAttribute('type','text');
        newField.setAttribute('name','surgery_name2[]');
        newField.setAttribute('class','ml-4 mr-6 h-10 mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm');
        newField.setAttribute('siz',50);
        newField.setAttribute('placeholder','Another Field');
        cell.appendChild(newField);
        ...
        var newField = document.createElement('input');
        newField.setAttribute('type','text');
        newField.setAttribute('name','no_of_surgeries2[]');
        newField.setAttribute('class','ml-6 mr-6 h-10 mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm');
        newField.setAttribute('siz',50);
        newField.setAttribute('placeholder','Another Field');
        cell.appendChild(newField);
        row.appendChild(cell);
...
var count4 = 0;
  function generate_table4() {
    count4++;
  // get the reference for the body
  var body = document.getElementById("inside4");
  ...
  for (var i = 0; i < 1; i++) {
    ...
    for (var j = 0; j < 1; j++) {
      ...
      // the end of the table row
        ...
        var newField = document.createElement('input');
        newField.setAttribute('type','text');
        newField.setAttribute('name','add_field_type');
        newField.setAttribute('class','ml-4 mr-6 h-10 mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm');
        newField.setAttribute('siz',50);
        newField.setAttribute('placeholder','Another Field');
        ...
        var newField = document.createElement('input');
        newField.setAttribute('type','text');
        newField.setAttribute('name','add_field_data[]');
        newField.setAttribute('class','ml-6 mr-6 h-10 mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm');
        newField.setAttribute('siz',50);
        newField.setAttribute('placeholder','Another Field');
        cell.appendChild(newField);
...
var count5 = 0;
  function generate_table5() {
    count5++;
  // get the reference for the body
  var body = document.getElementById("inside5");
    ...
    for (var j = 0; j < 1; j++) {
      ...
      // the end of the table row
        ...
        var newField = document.createElement('input');
        newField.setAttribute('type','text');
        newField.setAttribute('name','details3[]');
        newField.setAttribute('class','ml-4 mr-6 h-10 mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm');
        newField.setAttribute('siz',50);
        newField.setAttribute('placeholder','Another Field');
        newField.appendChild(body);


        var cell = document.createElement("td");
        var newField = document.createElement('input');
        newField.setAttribute('type','text');
        newField.setAttribute('name','amount[]');
        newField.setAttribute('class','ml-6 mr-6 h-10 mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm');
        newField.setAttribute('siz',50);
        newField.setAttribute('placeholder','Another Field');
        cell.appendChild(newField);
